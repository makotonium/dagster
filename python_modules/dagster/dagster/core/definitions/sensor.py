...
class SensorExecutionData(
    namedtuple("_SensorExecutionData", "run_requests skip_message cursor source_run_ids")
):
    def __new__(cls, run_requests=None, skip_message=None, cursor=None, source_run_ids=None):
